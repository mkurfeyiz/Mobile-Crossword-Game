...
public class EndOf34Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_of34);
        ...
        topScore34 = highScore.getInt("topScore34",0);
        if(intent.getIntExtra("3.4Score",0)>topScore34){
            highScore.edit().putInt("topScore34",intent.getIntExtra("3.4Score",0)).apply();
            highScore.edit().putString("username34",intent.getStringExtra("playerName")).apply();
            Toast.makeText(getApplicationContext(),"En Yüksek Skoru Elde Ettiniz!",Toast.LENGTH_SHORT).show();
        }

        score = findViewById(R.id.textViewScoreMessage34);
        name = findViewById(R.id.textViewNameMessage34);
        topScore = findViewById(R.id.textViewTopScoreMessage34);
        topScoreHolder = findViewById(R.id.textViewTopScoreHolder34);

        topScoreHolder.setText("Bölümün Skoreri : "+highScore.getString("username34",""));
        topScore.setText("En Yüksek Puan : "+highScore.getInt("topScore34",0));
        //Kopyalama sirasinda kacinci seviye skoru olduguna dikkat et.
        score.setText("Seviye Puanı : "+intent.getIntExtra("3.4Score",0));
        name.setText("Oyuncu Adı : "+intent.getStringExtra("playerName"));
    }

    public void startNextLvl(View view){
        toNext = new Intent(getApplicationContext(), ThirdLevel5Activity.class);
